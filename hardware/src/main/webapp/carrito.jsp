...
<main>
    ...
    <header>
        <h1>E-TECH</h1>
        <h2 id="destacado">Carrito de Compras</h2>
    </header>
    ...
    <div class="agrupar">
        <section>
            <!-- Aquí puedes agregar la tabla o lógica para mostrar los productos del carrito -->
            <table class="table">
                <thead>
                    <tr>
                        <th>Producto</th>
                ...
                <tbody>
                    <!-- Ejemplo de fila (deberías llenarlo dinámicamente) -->
                    <tr>
