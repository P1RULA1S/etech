            ...
            <section class="productos-section">
                <h3 class="section-title">
                    ...
                    <%
                        ...
                        if (cat != null && !cat.isEmpty()) {
                            ...
                            out.print(categoria.obtenerNombreCategoria(Integer.parseInt(cat)));
                        } else {
                            out.print("Resultados de búsqueda");
                        }
                    %>
                </h3>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
                    ...
                    if (cat != null && !cat.isEmpty()) {
                        ...
                        out.print(producto.consultarTodoEnTarjetasPorCategoria(categoriaId));
                    } else {
                        out.print("<div class='col-12 text-center py-5'><i class='fas fa-info-circle fa-3x mb-3'></i><p>Seleccione una categoría para ver productos</p></div>");
                    }
                    %>
                </div>
                
                <div class="text-center mt-4">
                    <a href="categoria.jsp" class="btn btn-primary">
