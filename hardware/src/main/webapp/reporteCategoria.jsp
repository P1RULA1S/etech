...
<head>
    <meta charset="UTF-8">
    <title>Resultados por Categoría - E-TECH</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bungee&family=Quantico&display=swap" rel="stylesheet">

    <!-- Estilos locales -->
    <link href="css/estilo1.1.css" rel="stylesheet" type="text/css">
    <link href="css/estilo-categoria.css" rel="stylesheet" type="text/css"> <!-- reutilizado -->
    ...
    <main>
        ...
        <div class="agrupar">
            <section class="form-container">
                <h3 class="titulo-categoria"><i class="fas fa-tags"></i> Resultados de búsqueda por categoría</h3>

                <div class="productos-container">
                    <%
                        String cat = request.getParameter("cmbCategoria");
                        if (cat != null && !cat.isEmpty()) {
                            int categoriaId = Integer.parseInt(cat);
                            Producto producto = new Producto();
                            out.print(producto.buscarProductoCategoria(categoriaId));
                        } else {
                            out.print("<p class='mensaje-error'>No se ha seleccionado ninguna categoría.</p>");
                        }
                    %>
                </div>

                <div class="volver-btn-contenedor">
                    <a href="categoria.jsp" class="btn-consultar"><i class="fas fa-arrow-left"></i> Volver al buscador</a>
                </div>
            </section>
